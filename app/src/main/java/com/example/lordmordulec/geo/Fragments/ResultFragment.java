...
public class ResultFragment extends Fragment {
    ...
    OnFragmentInteractionListener sluchaczF1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        userResultSetUp(view);
        return view;
    }
    public void userResultSetUp(View view)
    {
        CountriesActivity ca = new CountriesActivity();
        ContinentActivity continentActivity = new ContinentActivity();
        int res = 0;
        if(ca.getCorrect()!=0) {
            res= (ca.getCorrect()* 100 )/ ca.getCounter();
        }
        String str = continentActivity.getKontynent()+" " +res+ " %";
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onFragmentInteraction(Boolean ifSave);
    }
}
